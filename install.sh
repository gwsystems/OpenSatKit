...
OPEN_SAT_KIT_PATH="`pwd`"
fi

announce "Installing OpenSatKit v$OPEN_SAT_KIT_VERSION in \"$OPEN_SAT_KIT_PATH\""
announce "Make sure you're in the OSK directory to proceed!"
confirm "Continue?" 1
...
announce "Close this terminal. Open new terminal: cd \"$OPEN_SAT_KIT_PATH\"/cosmos/  and run 'ruby Launcher' "
